// hashset is a mutable generic unordered collection which only stores unique element. it does not allow duplicate elements and provides constant-time performance only basic task like add, remove and contains
