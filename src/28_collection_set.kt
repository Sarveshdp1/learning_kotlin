// set is generic unordered element collection that allows storing multiple datatype of elements but does not allow storing duplicate elements
...
fun main() {
    ...
    println("sum of all elements : ${numbers.sum()}")
    ...
    // iterator creates iterator and work based on cursor detailed explanation available in 27_collection_list.kt
