package c06_collections// map is unordered collection that stores data in key-value pairs, it uses linkedHashMap which uses linkedList like set to manage the order
...
fun main() {
    ...
    for (i in studAge.keys) {
        println("$i kt05_functions.age is ${studAge[i]}")
    }
