package c06_collections// hashmap is unordered mutable collection which stores data in key-value pair and the key needs to be unique but the value can be duplicate and the key only can store one value
