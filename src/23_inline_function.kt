...
fun main() {
    ...
    // so basically it copied the exact lamba and created as local lambda {print("hello"); return}, {print("world")} when executed in main function the return statement retuned the main function as well and program ended
