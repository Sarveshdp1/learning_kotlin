...
fun main() {
    ...
    outer@for (i in 0..googleEmployeeList.size-1) {
        if (googleEmployeeList[i] == "John") {
            println("\n\tYes John works in kt07_object_oriented_programming.Google")
            break@outer
        }
    }
    ...
    if (googleEmployeeList.contains("Yogesh")) {
        println("\n\tYes Yogesh works in kt07_object_oriented_programming.Google")
    } else {
        println("\n\tNo Yogesh not works in kt07_object_oriented_programming.Google")
    }

    // traversing
    println("\nHere is the list of kt07_object_oriented_programming.Google Employees:")
